...
echo_and_run cd "/home/sid/CIS690/src/Object_Recognition_model/spawn_robot_tools_pkg"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/sid/CIS690/src/Object_Recognition_model/spawn_robot_tools_pkg/setup.py" \
    build --build-base "/home/sid/CIS690/build/Object_Recognition_model/spawn_robot_tools_pkg" \
    install \
    --root="${DESTDIR-/}" \
