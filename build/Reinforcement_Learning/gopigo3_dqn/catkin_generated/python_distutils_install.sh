...
echo_and_run cd "/home/sid/CIS690/src/Reinforcement_Learning/gopigo3_dqn"
...
echo_and_run /usr/bin/env \
    ...
    "/usr/bin/python2" \
    "/home/sid/CIS690/src/Reinforcement_Learning/gopigo3_dqn/setup.py" \
    build --build-base "/home/sid/CIS690/build/Reinforcement_Learning/gopigo3_dqn" \
    install \
    --root="${DESTDIR-/}" \
